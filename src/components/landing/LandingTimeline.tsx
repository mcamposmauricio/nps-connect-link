    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="animate-fade-in-up">
          ...
          <h2 className="text-[28px] font-medium text-white mb-4" style={{ lineHeight: 1.25 }}>
            Track every interaction.<br />Every signal.<br />Every opportunity.
          </h2>
          <p className="text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.55)", maxWidth: 420 }}>
        ...
        {/* Right mockup */}
        <div
          className="rounded-2xl overflow-hidden animate-fade-in-up delay-200"
          style={{
            background: "#171C28",
        ...
        >
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[11px]" style={{ color: "rgba(255,255,255,0.4)" }}>Enterprise · SaaS</div>
            </div>
            <div className="flex items-center gap-2 flex-wrap">
              <span
                className="text-[11px] font-medium px-2 py-0.5 rounded-full"
                style={{ background: "rgba(46,212,122,0.15)", color: "#2ED47A" }}
              >
                ● Health 84
              </span>
              <span
                className="text-[11px] font-medium px-2 py-0.5 rounded-full"
                style={{ background: "rgba(61,165,244,0.1)", color: "#3DA5F4" }}
              >
                $12k MRR
              </span>
              <span
                className="text-[11px] font-medium px-2 py-0.5 rounded-full"
                style={{ background: "rgba(245,181,70,0.12)", color: "#F5B546" }}
              >
                Renewal soon
              </span>
            </div>
          ...
          <div className="px-5 py-5">
            <div className="text-[11px] font-medium uppercase tracking-wider mb-4" style={{ color: "rgba(255,255,255,0.3)" }}>
              Activity Timeline
            </div>
